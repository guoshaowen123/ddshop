...
<div class="weadmin-body">
    <form class="layui-form">
        ...
        <div class="layui-form-item layui-form-text">
            <label for="sellPoint" class="layui-form-label">类别名称</label>
            <div class="layui-input-block">
                <textarea placeholder="请输入类别名称" id="sellPoint" name="sellPoint" class="layui-textarea"></textarea>
            </div>
        </div>
        <div class="layui-form-item">
