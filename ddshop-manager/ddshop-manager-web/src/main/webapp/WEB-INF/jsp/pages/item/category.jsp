...
<head>
  ...
  <script type="text/javascript" src="${pageContext.request.contextPath}/static/js/listcategory.js" charset="utf-8"></script>
...
<div class="weadmin-body">
  <div class="layui-row">
    <form class="layui-form layui-col-md12 we-search" onsubmit="return false;">
      ...
      <div class="layui-inline">
        <input type="text" id="title" name="title" placeholder="请输入名称关键字" autocomplete="off" class="layui-input">
      </div>
  ...
  <div class="weadmin-block demoTable">
    ...
    <button class="layui-btn" onclick="WeAdminShow('添加种类','./addcategory',600,500)"><i class="layui-icon">&#xe61f;</i>添加</button>
  </div>
  ...
  <script type="text/html" id="myTpl2">
    <div class="layui-form">
      <input type="checkbox" name="itemStatus"  lay-filter="update" id="itemStatus" lay-skin="switch" value="{{d.status}}" lay-text="正常|失效" {{1==d.status?'checked':''}}/>
    </div>
  </script>
